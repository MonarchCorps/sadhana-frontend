        ...
        <div className='grid grid-cols-[auto_0.7fr_0.3fr_0.3fr_0.6fr_50px] items-center px-6 pt-[0.9rem] pb-4 border-b border-solid border-[#d2d1d1c8]'>
            ...
            <div className='text-start flex items-center ml-4'>
                ...
                <div>
                    <span className='font-500 text-base ml-3 tracking-tight align-text-top mb-1 block' title={course?.classname}>
                        {trim(course?.classname, 100)}
                    </span>
                    <span className='font-400 text-base ml-3 tracking-tight align-text-top -mb-1' title={course?.description}>
                        {trim(course?.description, 28)}
                    </span>
                </div>
            </div>
            ...
            <div className='text-center'>
                <span className='font-500 tracking-tight text-start -mb-1 text-sm'>
                    {format(course?.dateApplied, 'MMM, dd yyyy')}
                </span>
            </div>
