...
function UpdateClassForm({ handleSubmit, handleChange, preview, formData, handleTimeChange, dayArray, setDayArray, img, setImg, setPreview, ikUploadRef }) {
    ...
    const valid = Object.values(formData).every(value => value !== '' && value !== undefined && value !== '')

    return (
        <>
            <form className="grid grid-cols-2 gap-3 mt-7 max-w-[41rem] mx-auto" >
                <div className='col-span-2 mb-3'>
                    <UploadImageKit imgUrl={formData.thumbnailPhoto} img={img} setImg={setImg} setPreview={setPreview} ikUploadRef={ikUploadRef} isOpen={isOpen} setIsOpen={setIsOpen} preview={preview} imgName='thumbnailPhoto' />
                </div >
                ...
                <div>
                    ...
                    <div className='flex gap-3'>
                        <input type="time" name="startTime" id="startTime" className='border-[1px] border-solid border-[#aeacac] h-[40px] p-2 rounded w-full outline-none' onChange={handleTimeChange} value={formData.time.startTime} />
                        <input type="time" name="endTime" id="endTime" className='border-[1px] border-solid border-[#aeacac] h-[40px] p-2 rounded w-full outline-none' onChange={handleTimeChange} value={formData.time.endTime} />
                    </div>
                </div>
            ...
            <ModalContent isOpen={isOpen} onClose={() => setIsOpen(false)} preview={preview} imgUrl={formData.thumbnailPhoto} />
        </ >
    )
}
