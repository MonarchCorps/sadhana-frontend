...
function Trainer() {
    ...
    return (
        <section>
            <div className="max-w-[90%] mx-auto pt-24 grid grid-cols-3 gap-10">
                <div className="bg-[url('./assets/images/Orn-1.png')] bg-no-repeat">
                    <div>
                        ...
                        <Link
                            to='/instructor'
                            onClick={scrollTop}
                            className='text-sm px-7 py-4 mr-2 bg-[#e5759a] rounded-full text-slate-50 shadow-inner p-1 mt-6'
                        >
                            More about trainer
                        </Link>
                    </div>
