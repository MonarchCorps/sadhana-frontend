function ClassesOverview() {
    return (
        <div className="grid grid-cols-2 items-center mb-10 hrmd:grid-cols-1">
            <div>
                <h3 className="font-crimson text-[26px] mb-4 tracking-wide lg:text-2xl">Yoga Classes</h3>
                <h1 className="text-[2.57rem] lg:text-4xl leading-[1.18] font-500 font-sans mb-6">
                    Let the threads of life get connected with yoga
                </h1>
            </div>
            <div>
                <p className=" text-[#3a3939] leading-[1.6] lg:text-base">
