function LeftChooseUs() {
    ...
    return (
        <div className="w-[45%]">
            <h3 className="font-crimson text-[26px] mb-4 tracking-wide">Why Choose Us</h3>
            <h1 className="text-[2.8rem] leading-[1.18] font-500 font-sans mb-6">You can always control what goes on inside</h1>
