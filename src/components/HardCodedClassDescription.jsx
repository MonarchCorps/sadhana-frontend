...
function HardCodedClassDescription() {
    return (
        <Fragment>
            <div className='mt-8'>
                <h1 className='font-500 text-xl mb-4'>Course description</h1>
            ...
            <div className='mt-8'>
                <div className='bg-[#f8f8f8] p-7 rounded-xl'>
                    <h1 className='font-500 text-xl mb-4'>What you learn?</h1>
            ...
            <div className='mt-8'>
                <h1 className='font-500 text-xl mb-4'>Lesson plan</h1>
                <p className='text-base leading-[1.65]'>
